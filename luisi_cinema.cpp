/*
    ...
    Author: Luisi Paolo
    Date: 19/10/22 09:39
    Description:In un cinema multisala si attuano delle particolari riduzioni sul costo del biglietto di ingresso, sulla base del sesso e dell’età del cliente: fino a 18 anni, sconto del 15%, da 19 a 64 anni, nessuna riduzione; da 65 anni in su, per le donne riduzione del 25%, per gli uomini del 20%.
                Dati in input il costo del biglietto, il sesso e l’età del cliente, calcolare e dare in output l’importo da pagare.
*/
